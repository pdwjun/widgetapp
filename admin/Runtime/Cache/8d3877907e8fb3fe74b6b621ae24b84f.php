  ...
  <tr>
	...
	<!-- Item 1 Strat -->
      ...
      <dl class='bitem'>
        ...
        <dt onClick='showHide("items1_1")'><b>网站配置管理</b></dt>
          ...
          <ul class='sitemu'>
            ...
            <li>
              ...
              <div class='items'>
                ...
                <div class='fllct'><a href='<?php echo U('Config/index');?>' target='main'>网站参数设置</a></div>
             ...
             <li>
              ...
              <div class='items'>
                ...
                <div class='fllct'><a href='<?php echo U('Config/admin');?>' target='main'>管理员设置</a></div>
          ...
          <ul class='sitemu'>
            ...
            <li>
              ...
              <div class='items'>
                ...
                <div class='fllct'><a href="<?php echo U('Link/index');?>" target='main'>友情链接管理</a></div>
              ...
              <div class='items'>
                ...
                <div class='fllct'><a href="<?php echo U('Link/add');?>"' target='main'>添加友情链接</a></div>
