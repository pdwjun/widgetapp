  ...
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	...
        	[<a href="http://<?php echo ($site_url); ?>" target="_blank">网站主页</a>]



        	[<a href="<?php echo U('exits');?>" target="_top">注销退出</a>]&nbsp;
      ...
      <tr>
		...
		<dd class='img'><a href="javascript:ChangeMenu(-1);"><img vspace="5" src="__PUBLIC__/skin/admin/images/frame/arrl.gif" border="0" width="5" height="8" alt="缩小左框架"  title="缩小左框架" /></a></dd>

		<dd class='img'><a href="javascript:ChangeMenu(0);"><img vspace="3" src="__PUBLIC__/skin/admin/images/frame/arrfc.gif" border="0" width="12" height="12" alt="显示/隐藏左框架" title="显示/隐藏左框架" /></a></dd>

		<dd class='img' style="margin-right:10px;"><a href="javascript:ChangeMenu(1);"><img vspace="5" src="__PUBLIC__/skin/admin/images/frame/arrr.gif" border="0" width="5" height="8" alt="增大左框架" title="增大左框架" /></a></dd>

		<dd><div class='itemsel' id='item1' onMouseMove="mv(this,'move',1);" onMouseOut="mv(this,'o',1);"><a href="<?php echo U('Index/menu');?>" onclick="changeSel(1)" target="menu">主菜单</a></div></dd>

		<dd><div class='item' id='item2' onMouseMove="mv(this,'m',2);" onMouseOut="mv(this,'o',2);"><a href="<?php echo U('Index/menu_article');?>" onclick="changeSel(2)" target="menu">内容发布</a></div></dd>
		...
		<dd><div class='item' id='item9' onMouseMove="mv(this,'m',9);" onMouseOut="mv(this,'o',9);"><a href="<?php echo U('Index/main');?>" onclick="changeSel(9)" target="main">后台主页</a></div></dd>
